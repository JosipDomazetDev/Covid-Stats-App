...
class GlobalEntry {
    ...
    constructor(attribute: String, value: String, state: Int = NEGATIVE, addSepAbove: Boolean = false) {
    ...
    constructor(attribute: String, value: Number?, state: Int = NEGATIVE, addSepAbove: Boolean = false) {
        this.attribute = attribute
